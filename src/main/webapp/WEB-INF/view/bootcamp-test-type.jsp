...
<html>
<head>
<title>XBC | Bootcamp Test Type</title>
...
<script>
	...
	function loadForm(id) {
		if (id == null) {
			$('#form-BootcampTestType').trigger("reset");
			$('#id').val('');
		} else {
			$.ajax({
				type : 'get',
	...
	function submitForm() {
		var unindexed_data = $('#form-BootcampTestType').serializeArray();
		var data = {};
	...
	$(document).ready(function() {
		tableNih = $('#table-BootcampTestType').DataTable({
			'searching' : false,
			'lengthChange' : false,
			'lengthMenu' : [ 10 ]
		});
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						<table id="table-BootcampTestType"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Bootcamp Test Type</h4>
						</div>
